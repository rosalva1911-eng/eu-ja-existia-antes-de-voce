...
def render_livro():
    ...
    st.image("assets/14_voltar_para_si.png", use_container_width=True)
    ...
    st.markdown(
        "Você não chegou até aqui por acaso. Cada página lida foi um passo de volta para si.\n\n"
        "Florescer não é virar outra pessoa. É lembrar quem você sempre foi antes de se esquecer.\n\n"
        "Permita-se crescer no seu tempo, honrar suas emoções, respeitar seus ciclos "
        "e escolher caminhos que sustentem quem você é.\n\n"
        "Que você siga se escolhendo, com gentileza, coragem e verdade.\n\n"
        "Você já existia antes de qualquer dor. E continuará existindo — agora, mais inteira."
    )
